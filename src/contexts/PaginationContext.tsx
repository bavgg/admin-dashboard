...
type PaginationContextType = {
  currentPage: number,
  setCurrentPage: ( (value: number ) => void ) & ((value: (value: number) => number)=> void),
  totalPages: number;
...
export function PaginationProvider({children}: { children: ReactNode}) {
  ...
  return (
    <PaginationContext.Provider value={{ currentPage, setCurrentPage, totalPages, setTotalPages, contentPerPage, setContentPerPage }}>
      {children}
